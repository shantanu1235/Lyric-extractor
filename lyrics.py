...
conn = msl.connect(host = "localhost", port = 3306, user = "root", password = "")
print("Database Connected")
c = conn.cursor()
c.execute("CREATE DATABASE if not exists Lyrics_User")
print("Database Created")
conn = msl.connect(host = "localhost", port = 3306, user = "root", password = "", database = "Lyrics_User")
c = conn.cursor()
